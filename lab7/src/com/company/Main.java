...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Biggest Surface = "+ GeometricBodyController.getBiggestSurfaceBody(bodies).getSurface());
        System.out.println("Biggest Volume = "+ GeometricBodyController.getBiggestVolumeBody(bodies).getVolume());
